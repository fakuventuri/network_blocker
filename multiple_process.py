...
def block_device(
    ...
    process = subprocess.Popen(arpspoof_cmd)
    return process
    ...
    try:
        while True:
            try:
                ...
                choice = int(
                    input(
                        "Enter the index of the device to block/unblock, -2 to unblock all, or -1 to exit: "
                    )
                )
                ...
                if choice == -1:
                    ...
                    if any(
                        ...
                        print("Unblocking", selected_device[0])
                        blocked_devices = [
                            process
                            for process in blocked_devices
                        ...
                        print("Blocking", selected_device[0])
